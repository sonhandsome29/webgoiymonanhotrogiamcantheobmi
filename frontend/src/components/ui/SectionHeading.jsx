  ...
  return (
    <div className="section-heading flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
      <div className="max-w-3xl">
        <span className="eyebrow eyebrow--soft inline-flex items-center rounded-full bg-[var(--glass-bg)] border border-[var(--line)] px-3 py-1 shadow-sm">
          {eyebrow}
        </span>
        <h2 className="font-heading text-[var(--ink)]">{title}</h2>

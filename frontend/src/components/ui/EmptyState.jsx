function EmptyState({ title, description, action, className = '' }) {
  return (
    <div className={`empty-state flex min-h-[180px] flex-col justify-center gap-3 rounded-3xl border border-sone-line bg-white/85 p-6 shadow-soft ${className}`.trim()}>
